...
(function() {
    ...
    yList = [11.96, 54.07, 11.55, 10.35, 45.14, 7.70, 7.13, 7.62];
...
(function() {
    ...
    var option = {
        ...
        yAxis: [{
            ...
            {
                inverse: true,
                data: [29.83, 20.89, 4.79, 3.22, 2.55],
                //不显示纵轴
                axisLine: {
                    show: false
                },
...
(function() {
    var yearData = [{
            ...
            data: [
                // 两个数组是因为有两条线
                [288, 167, 211, 244, 255, 302, 268, 294, 286, 257, 254, 270],
                [40, 24, 101, 204, 140, 210, 150, 163, 100, 110, 180, 159]
            ]
        },
        {
            year: "2021", // 年份
            data: [
                // 两个数组是因为有两条线
                [358, 107, 111, 244, 355, 342, 208, 214, 116, 257, 254, 270],
                [210, 24, 71, 154, 100, 150, 70, 113, 60, 110, 180, 159]
            ]
        }
    ];
